<div>
    <!-- Hero Section -->
    <x-hero-section title="{{ __('messages.our_portfolio') }}" subtitle="{{ __('messages.portfolio_subtitle') }}" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
                ...
                @foreach ($portfolios as $portfolio)
                    ...
                    class="group relative bg-gray-100 rounded-lg shadow-lg overflow-hidden block h-60">
                        ...
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-0 group-hover:opacity-75 transition">
                        </div>
                        <div
    ...
    <section class="py-20 px-6 bg-gray-100 text-center">
        <h3 class="text-3xl font-bold text-gray-900 mb-4">{{ __('messages.cta_heading') }}</h3>
        <p class="text-lg text-gray-600 mb-6">{{ __('messages.cta_description') }}</p>
